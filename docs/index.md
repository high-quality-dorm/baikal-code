...
| План устранения замечаний бэкенда (rate limit, PII, роли, аудит) | [fixes.md](fixes.md)           |
...
| `fixes.md`           | План поэтапного устранения замечаний бэкенда: rate limit, PII, `resolve_role`, аудит | Что исправляем в бэкенде и в каком порядке    |
