...
| План устранения замечаний бэкенда: rate limit, PII, роли, аудит (все выполнены) | [fixes.md](fixes.md)           |
...
| `fixes.md`           | План поэтапного устранения замечаний бэкенда: rate limit, PII, `resolve_role`, аудит — все этапы выполнены | Что исправляли в бэкенде и в каком порядке, как решали |
