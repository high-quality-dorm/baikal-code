...
| ---------------------------------------------------------- | ----------------------------------- |
| Что это за проект, как запустить                          | [README](../README.md)              |
| Требования: кто что может видеть, PII-политика            | [about.md](about.md)                |
...
| `about.md`           | Роли пользователей (абитуриент/студент/преподаватель/админ), что выводимо и что запрещено, PII-политика | Уточнить бизнес-требования по доступу         |
