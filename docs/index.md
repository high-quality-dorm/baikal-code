...
| `roles.md`          | Роли пользователей (абитуриент/студент/преподаватель/админ), что выводимо и что запрещено, PII-политика; служебные роли и связь учётки с человеком (`internal_id`) | Уточнить бизнес-требования по доступу, понять identity |
